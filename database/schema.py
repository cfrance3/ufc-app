def create_tables(cursor):
    ...
    cursor.execute('''
        ...
        fighter1_head_strikes INTEGER DEFAULT 0,
        fighter2_head_strikes INTEGER DEFAULT 0,
        fighter1_head_strikes_att INTEGER DEFAULT 0,
        fighter2_head_strikes_att INTEGER DEFAULT 0,
        fighter1_body_strikes INTEGER DEFAULT 0,
        fighter2_body_strikes INTEGER DEFAULT 0,
        fighter1_body_strikes_att INTEGER DEFAULT 0,
        fighter2_body_strikes_att INTEGER DEFAULT 0,
        fighter1_leg_strikes INTEGER DEFAULT 0,
        fighter2_leg_strikes INTEGER DEFAULT 0,
        fighter1_leg_strikes_att INTEGER DEFAULT 0,
        fighter2_leg_strikes_att INTEGER DEFAULT 0,
